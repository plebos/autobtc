export const clnNodeMessages = {
    ...
    stageTwo: `
        ...
        <pre>lightning-cli commando-rune restrictions='[["id=PUBLIC_KEY_PLACEHOLDER"], ["method^list","method^get","method^bkpr","method=summary","method=decode", "method=invoice", "method=waitanyinvoice","method=waitinvoice", "method=offer"],["method/listdatastore"], ["rate=60"]]' | jq -r '.rune'</pre>
